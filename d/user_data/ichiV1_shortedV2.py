...
class ichiV1_shorted(IStrategy):
    ...
    buy_params = {
        ...
        "buy_min_fan_magnitude_gain": 1.002 #1.002 NOTE: Good value (Win% ~70%), alot of trades
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        short_conditions.append(
            dataframe['fan_magnitude_gain'] <= (2 - self.buy_params['buy_min_fan_magnitude_gain'])
        )
